          ...
          onAction={async (action, row) => {
            if (action === 'Edit') {
              ...
              const result = await Swal.fire({
                ...
                reverseButtons: true,
                customClass: {
                  confirmButton: 'bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 focus:outline-none mr-2',
                  cancelButton: 'bg-gray-300 text-black px-4 py-2 rounded hover:bg-gray-400 focus:outline-none',
                },
