            ...
            <li className="mt-[20px]">
                <div className="flex items-center gap-2">
                    ...
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="text-[#31394f] text-[14px] leading-[16px]">Status</span>
                    </div>
                    <div className="flex items-center gap-2">
                        
                        <a href="#" className="bg-[#ec4899] text-white text-[12px] leading-[16px] px-[9px] py-[4px] rounded-[8px] font-500">To Do</a>
                    </div>
                </div>
            </li>
            <li className="mt-[10px]">
                <div className="flex items-center gap-2">
                    ...
                    <svg
                        ...
                        <span className="text-[#31394f] text-[14px] leading-[16px]">Due Date</span>
                    </div>
                    <div className="flex items-center gap-2">
            ...
            <li className="mt-[10px]">
                <div className="flex items-center gap-2">
                    ...
                    <g opacity="0.9">
                        ...
                        <span className="text-[#31394f] text-[14px] leading-[16px]">Attachment</span>
                    </div>
                    <div className="flex items-center gap-2">
                        
                    <div className="text-[#7980ff] border border-[#7980ff] py-[2px] px-[8px] rounded-[8px] text-[10px] leading-[16px]">Refereences.pdf</div>
                    {/* <Input
                    type="file"
                    classNames={{
